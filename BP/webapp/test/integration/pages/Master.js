		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <BusinessPartnerRole>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<BusinessPartnerRole>", "<100 <EmailAddress>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<BusinessPartnerRole> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("BusinessPartnerRole", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber : function () {
					return this.theListShouldBeSortedAscendingOnField("BusinessPartnerRole");
				},
